            ...
            <div class="card-body">
                <form action="<?php echo e(route('admin.rooms.update', $room->id)); ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="model" placeholder="Model (Plate)" name="model" value="<?php echo e(old('model', $room->model)); ?>" />
                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\xampp\htdocs\driver\resources\views/admin/rooms/edit.blade.php ENDPATH**/ ?>